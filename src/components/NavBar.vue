...
<template>
    <header class="header z-40">
        <RouterLink class="w-12 h-12 absolute xl:fixed m-5 select-none outline-none" to="/" focusable="false">
            <img src="/logo.svg" alt="Joie Pink" class="w-12 h-12" />
        </RouterLink>
        <button
            title="Scroll to top"
            fixed
        ...
        <nav class="nav">
            ...
            <div class="right" print:op0>
                ...
                <RouterLink to="/translations" title="Notes">
                    <span class="lt-md:hidden">Translations</span>
                    <div i-carbon-notebook class="md:hidden" />
                </RouterLink>
